...
class Cviewprofile extends React.Component {
    ...
    render(){
        const { username, compname } = this.props.route.params;
        ...
        return(<>
            <Text style={{position: 'relative', top: 70, left: 15,fontSize: 26}}>Student's Profile:</Text>
            ...
            <Button title="Go to Home" onPress={()=>{this.props.navigation.navigate('CHome', {username: compname})}} />
            </View>
        </>)
    }
}
...
export default function(props) {
    ...
    return <Cviewprofile {...props} navigation={navigation} />;
  }